<?php
  ...
  if(!isset($_SESSION['login'])){
   ...
   // jangan biarkan ke halaman login jika sudah berada di dashboard
...
<head>
   ...
   <title>Login - System Kasir</title>
               ...
               <div class="row justify-content-center">
                  <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                     ...
                     <div class="credits text-center">
                        ...
                        Modify by <a href="https://www.instagram.com/erimaulana.69/"><strong>Eri Maulana</strong></a>
                     </div>
